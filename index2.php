                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="collapse" data-parent="#accordion" href="#collapseCadastro" aria-controls="collapseCadastro">
                                ...
                                <span class="menu-title">Cadastro<i class="fa fa-sort-down"></i></span>
                            </a>
                            <div class="collapse" id="collapseCadastro">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item">
                                        <a class="nav-link" href="pages/cadastro_cliente.php">
                                      Cliente
                                    </a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="collapse" data-parent="#accordion" href="#collapseOs" aria-controls="collapseOs">
                                ...
                                <span class="menu-title">Ordem de Serviço<i class="fa fa-sort-down"></i></span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="collapse" data-parent="#accordion" href="#collapsepecas" aria-controls="collapsepecas">
                                ...
                                <span class="menu-title">Peças<i class="fa fa-sort-down"></i></span>
                            </a>
                        ...
                        <li class="nav-item">
                          ...
                          <li class="nav-item">
                            <a class="nav-link" data-toggle="collapse" data-parent="#accordion" href="#collapseconfiguracao" aria-controls="collapseconfiguracao">
                                <!-- <i class="fa fa-address-book"></i> -->
                                <img src="images/icons/4.png" alt="">
                                <span class="menu-title">Configuração<i class="fa fa-sort-down"></i></span>
                            </a>
                            <div class="collapse" id="collapseconfiguracao">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item">
                                        <a class="nav-link" href="samples/blank_page.html">
                                      Usuário/Grupo
