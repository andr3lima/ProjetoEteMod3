...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10-Mar-2020 às 21:01
...
INSERT INTO `atividades` (`IDatividade`, `NomeAtividade`, `Disciplina`, `DataEntrega`, `IDusuario`, `excluido`, `concluido`, `status`) VALUES
(4, 'Modelo Incremental', '10', '2020-04-06', 6, 0, 0, 1),
(5, 'Atividade 2', '10', '2020-03-04', 6, 0, 0, 3),
(6, 'Atividade nova', '12', '2020-04-09', 6, 0, 1, 1);
...
--
ALTER TABLE `atividades`
  MODIFY `IDatividade` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
